...
export function CliVersionInfo():Promise<main.BuildInfo>;
...
export function NetworkManager():Promise<net.NetworkManager>;
...
export function SimulationManager():Promise<sim.Manager>;

export function StartSimulation(arg1:string):Promise<void>;

export function StopSimulation(arg1:string):Promise<void>;

export function UpdateProgram(arg1:string):Promise<void>;

export function UpdateTemplateRegistry():Promise<void>;

export function VersionInfo():Promise<main.BuildInfo>;
